...
with st.sidebar:
    ...
    feedback_text = st.text_area(
        ...
        height=100, label_visibility="collapsed", key="feedback_text"
    )
    feedback_mailto = (
    ...
    <a href="{feedback_mailto}" target="_blank" style="text-decoration:none">
        <div style="background:linear-gradient(135deg,#003322,#006644);border:1px solid rgba(0,200,100,0.35);
             border-radius:10px;padding:10px 14px;text-align:center;font-size:0.8rem;font-weight:600;
             color:#00ee77;cursor:pointer;margin-top:8px;letter-spacing:0.5px;">
            📧 Send Feedback
        </div>
    </a>
